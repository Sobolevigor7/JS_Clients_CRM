# Пример JavaScript приложения CRM системы учета клиентов. 
# Example of JavaScript CRM App.
Данные хранятся на сервере, описание процедуры запуска сервера ниже. После запуска сервера приложение запускается из index.html

# REST API для базы данных клиентов

Перед запуском убедитесь, что вы установили Node.js версии 12 или выше.

Для запуска сервера перейдите в папку server и выполните команду `node index`. Для остановки нажмите сочетание клавиш CTRL+C.
